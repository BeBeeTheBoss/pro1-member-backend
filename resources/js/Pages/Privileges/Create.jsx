...
export default function CreatePrivilege({ user, categories }) {
    ...
    const submit = (e) => {
        ...
        post("/privileges", { forceFormData: true });
    };
        ...
        <AuthenticatedLayout user={user}>
            <div className="max-w-3xl mx-auto">
                <div className="flex justify-between items-center mb-4">
                    <h4 className="text-xl font-bold text-white">Create Privilege</h4>
                </div>
