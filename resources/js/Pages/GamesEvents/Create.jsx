...
export default function CreateGamesEvent({ user, branches = [] }) {
    ...
    const submit = (e) => {
        ...
        post("/games-events", { forceFormData: true });
    };
        ...
        <AuthenticatedLayout user={user}>
            <div className="max-w-3xl mx-auto">
                <div className="flex justify-between items-center mb-4">
                    <h4 className="text-xl font-bold text-white">Create Games Event</h4>
                </div>
                ...
                >
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <div>
                            <label className="block text-lg mb-2 text-white">Image <span className="text-red-400">*</span></label>
                            <input
                                type="file"
                                accept="image/*"
                                onChange={(e) => {
