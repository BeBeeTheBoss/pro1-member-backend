...
export default function EventPlatforms({ user, platforms }) {
    const [data, setData] = useState(platforms.data ?? platforms);
    ...
    const deletePlatform = () => {
        router.delete(`/event-platforms/${deleteId}`, {
            onSuccess: () => {
        ...
        <AuthenticatedLayout user={user}>
            <div>
                <div className="flex justify-between px-2 items-center mb-4">
                    <h4 className="text-xl font-bold">Event Platforms</h4>
                    <div>
                        <Link href={route("event-platforms.create")}>
                                ...
                                {paginated.map((p, i) => (
                                    ...
                                    >
                                        <td className="px-4 py-3 flex">
                                            <button
                                                onClick={() =>
                                                    router.get(`/event-platforms/edit/${p.id}`)
                                                }
